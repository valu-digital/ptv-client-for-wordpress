<?php
/**
 * PTV_Service_Asti_Service_Channel_By_Source
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PTV_Service_Asti_Service_Channel_By_Source Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://www.valu.fi
 */
class PTV_Service_Asti_Service_Channel_By_Source implements ArrayAccess {

	/**
	  * The original name of the model.
	  * @var string
	  */
	protected static $model_name = 'PTV_Service_Asti_Service_Channel_By_Source';
	...
	public function set_service_channel_source_id( $service_channel_source_id ) {
		...
		if ( ( ! preg_match( '/^[A-Za-z0-9-.]*$/', $service_channel_source_id ) ) ) {
			throw new InvalidArgumentException( "invalid value for $service_channel_source_id when calling PTV_Service_Asti_Service_Channel_By_Source., must conform to the pattern /^[A-Za-z0-9-.]*$/." );
		}

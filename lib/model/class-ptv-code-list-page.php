...
/**
 * PTV_Code_List_Page Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://www.valu.fi
 */
class PTV_Code_List_Page implements ArrayAccess {

	/**
	  * The original name of the model.
	  * @var string
	  */
	protected static $model_name = 'PTV_Code_List_Page';
	...
	/**
	 * Sets item_list
	 * @param PTV_Code_List_Item[] $item_list List of code list items.
	 * @return $this
	 */

...
/**
 * PTV_Entitity_Guid_Page Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://www.valu.fi
 */
class PTV_Entitity_Guid_Page implements ArrayAccess {

	/**
	  * The original name of the model.
	  * @var string
	  */
	protected static $model_name = 'PTV_Entitity_Guid_Page';
	...
	/**
	 * Sets item_list
	 * @param PTV_Entity_Item[] $item_list List of entity Guids.
	 * @return $this
	 */

<?php
/**
 * PTV_Service_And_Channel_Relation_In_Base
 *
 * PHP version 5
 *
 * @category Class
 ...
 * @link        https://www.valu.fi
 */
class PTV_Service_And_Channel_Relation_In_Base implements ArrayAccess {

	/**
	  * The original name of the model.
	  * @var string
	  */
	protected static $model_name = 'PTV_Service_And_Channel_Relation_In_Base';
	...
	protected static $types = array(
		...
		'channel_relations' => 'PTV_Service_Service_Channel_In_Base[]',
	);
	 ...
	 * @return PTV_Service_Service_Channel_In_Base[]
	 */
	 ...
	 * @param PTV_Service_Service_Channel_In_Base[] $channel_relations Gets or sets the channel relations.
	 * @return $this
	 */

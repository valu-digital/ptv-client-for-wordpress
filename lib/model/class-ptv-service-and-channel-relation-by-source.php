<?php
/**
 * PTV_Service_And_Channel_Relation_By_Source
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PTV_Service_And_Channel_Relation_By_Source Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://www.valu.fi
 */
class PTV_Service_And_Channel_Relation_By_Source implements ArrayAccess {

	/**
	  * The original name of the model.
	  * @var string
	  */
	protected static $model_name = 'PTV_Service_And_Channel_Relation_By_Source';
	...
	protected static $setters = array(
		'service_source_id' => 'set_service_source_id',
	...
	protected static $getters = array(
		'service_source_id' => 'get_service_source_id',
	...
	public function __construct( array $data = null ) {
		$this->container['service_source_id'] = isset( $data['service_source_id'] ) ? $data['service_source_id'] : null;
	...
	public function list_invalid_properties() {
		...
		if ( null === $this->container['service_source_id'] ) {
			$invalid_properties[] = "'service_source_id' can't be null";
		}
		if ( ! preg_match( '/^[A-Za-z0-9-.]*$/', $this->container['service_source_id'] ) ) {
			$invalid_properties[] = "invalid value for 'service_source_id', must be conform to the pattern /^[A-Za-z0-9-.]*$/.";
		}
	...
	/**
	 * Gets service_source_id
	 * @return string
	 */
	public function get_service_source_id() {
		return $this->container['service_source_id'];
	}

	/**
	 * Sets service_source_id
	 * @param string $service_source_id The external source id for service.
	 * @return $this
	 */
	public function set_service_source_id( $service_source_id ) {

		if ( ( ! preg_match( '/^[A-Za-z0-9-.]*$/', $service_source_id ) ) ) {
			throw new InvalidArgumentException( "invalid value for $service_source_id when calling PTV_Service_And_Channel_Relation_By_Source., must conform to the pattern /^[A-Za-z0-9-.]*$/." );
		}

		$this->container['service_source_id'] = $service_source_id;
	...
	public function set_service_channel_source_id( $service_channel_source_id ) {
		...
		if ( ( ! preg_match( '/^[A-Za-z0-9-.]*$/', $service_channel_source_id ) ) ) {
			throw new InvalidArgumentException( "invalid value for $service_channel_source_id when calling PTV_Service_And_Channel_Relation_By_Source., must conform to the pattern /^[A-Za-z0-9-.]*$/." );
		}

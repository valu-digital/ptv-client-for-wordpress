...
/**
 * PTV_Address_With_Moving_In Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://www.valu.fi
 */
class PTV_Address_With_Moving_In implements ArrayAccess {

	/**
	  * The original name of the model.
	  * @var string
	  */
	protected static $model_name = 'PTV_Address_With_Moving_In';
	...
	protected static $types = array(
		...
		'multipoint_location' => 'PTV_Street_Address_With_Coordinates_In[]',
		'country' => 'string',
	);
	 ...
	 * @param PTV_Language_Item[] $location_abroad Localized list of foreign address information. (Max.Length: 500).
	 * @return $this
	 */
	 ...
	 * @param PTV_Street_Address_With_Coordinates_In[] $multipoint_location Moving address. Includes several street addresses.
	 * @return $this
	 */
	...
	public function set_country( $country ) {
		...
		if ( ! is_null( $country ) && ( ! preg_match( '/^[A-Z]{2}$/', $country ) ) ) {
			throw new InvalidArgumentException( "invalid value for $country when calling PTV_Address_With_Moving_In., must conform to the pattern /^[A-Z]{2}$/." );
		}

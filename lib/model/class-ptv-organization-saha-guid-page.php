...
/**
 * PTV_Organization_Saha_Guid_Page Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://www.valu.fi
 */
class PTV_Organization_Saha_Guid_Page implements ArrayAccess {

	/**
	  * The original name of the model.
	  * @var string
	  */
	protected static $model_name = 'PTV_Organization_Saha_Guid_Page';
	...
	protected static $types = array(
		...
		'page_size' => 'int',
		'page_count' => 'int',
		'item_list' => 'PTV_Organization_Saha[]',
	);
	...
	/**
	 * Sets item_list
	 * @param PTV_Organization_Saha[] $item_list List of entity Guids.
	 * @return $this
	 */

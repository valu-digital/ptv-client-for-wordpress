<?php
/**
 * PTV_Service_And_Channel_Asti_Relation_By_Source
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PTV_Service_And_Channel_Asti_Relation_By_Source Class Doc Comment
 *
 * @category    Class
 * @description OPEN API V7 - View Model of service and channel relation IN by source (PUT).
 * @author      Valu Digital
 * @link        https://www.valu.fi
 */
class PTV_Service_And_Channel_Asti_Relation_By_Source implements ArrayAccess {

	/**
	  * The original name of the model.
	  * @var string
	  */
	protected static $model_name = 'PTV_Service_And_Channel_Asti_Relation_By_Source';
	...
	protected static $types = array(
		...
		'channel_relations' => 'PTV_Service_Asti_Service_Channel_By_Source[]',
	);
	 ...
	 * @return PTV_Service_Asti_Service_Channel_By_Source[]
	 */
	 ...
	 * @param PTV_Service_Asti_Service_Channel_By_Source[] $channel_relations Gets or sets the channel relations.
	 * @return $this
	 */

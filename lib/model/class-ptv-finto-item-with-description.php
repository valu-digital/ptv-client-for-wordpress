<?php
/**
 * PTV_Finto_Item_With_Description
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PTV_Finto_Item_With_Description Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://www.valu.fi
 */
class PTV_Finto_Item_With_Description implements ArrayAccess {

	/**
	  * The original name of the model.
	  * @var string
	  */
	protected static $model_name = 'PTV_Finto_Item_With_Description';
	...
	/**
	 * Sets description
	 * @param PTV_Language_Item[] $description List of localized entity descriptions.
	 * @return $this
	 */

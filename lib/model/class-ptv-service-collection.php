...
/**
 * PTV_Service_Collection Class Doc Comment
 *
 * @category    Class
 * @description OPEN API V7 - View Model of service collection
 * @author      Valu Digital
 * @link        https://www.valu.fi
 */
class PTV_Service_Collection implements ArrayAccess {

	/**
	  * The original name of the model.
	  * @var string
	  */
	protected static $model_name = 'PTV_Service_Collection';
	...
	protected static $types = array(
		...
		'services' => 'PTV_Service_Collection_Service[]',
	...
	public function set_source_id( $source_id ) {
		...
		if ( ! is_null( $source_id ) && ( ! preg_match( '/^[A-Za-z0-9-.]*$/', $source_id ) ) ) {
			throw new InvalidArgumentException( "invalid value for $source_id when calling PTV_Service_Collection., must conform to the pattern /^[A-Za-z0-9-.]*$/." );
		}
	...
	/**
	 * Gets services
	 * @return PTV_Service_Collection_Service[]
	 */
	...
	/**
	 * Sets services
	 * @param PTV_Service_Collection_Service[] $services List of service collection services.
	 * @return $this
	 */

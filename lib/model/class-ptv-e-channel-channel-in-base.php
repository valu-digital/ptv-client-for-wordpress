 ...
 * @link        https://www.valu.fi
 */
class PTV_EChannel_Channel_In_Base implements ArrayAccess {

	/**
	  * The original name of the model.
	  * @var string
	  */
	protected static $model_name = 'PTV_EChannel_Channel_In_Base';
	...
	public function set_source_id( $source_id ) {
		...
		if ( ! is_null( $source_id ) && ( ! preg_match( '/^[A-Za-z0-9-.]*$/', $source_id ) ) ) {
			throw new InvalidArgumentException( "invalid value for $source_id when calling PTV_EChannel_Channel_In_Base., must conform to the pattern /^[A-Za-z0-9-.]*$/." );
		}
	 ...
	 * @param bool $delete_all_attachments Set to true to delete all existing attachments. The attachments collection should be empty when this property is set to true.
	 * @return $this
	 */

...
/**
 * PTV_Service_Collection_In_Base Class Doc Comment
 *
 * @category    Class
 * @description OPEN API V7 - View Model of service collection IN - base
 * @author      Valu Digital
 * @link        https://www.valu.fi
 */
class PTV_Service_Collection_In_Base implements ArrayAccess {

	/**
	  * The original name of the model.
	  * @var string
	  */
	protected static $model_name = 'PTV_Service_Collection_In_Base';
	...
	protected static $setters = array(
		...
		'delete_all_services' => 'set_delete_all_services',
	...
	protected static $getters = array(
		...
		'delete_all_services' => 'get_delete_all_services',
	...
	public function __construct( array $data = null ) {
		...
		$this->container['delete_all_services'] = isset( $data['delete_all_services'] ) ? $data['delete_all_services'] : null;
	...
	public function set_source_id( $source_id ) {
		...
		if ( ! is_null( $source_id ) && ( ! preg_match( '/^[A-Za-z0-9-.]*$/', $source_id ) ) ) {
			throw new InvalidArgumentException( "invalid value for $source_id when calling PTV_Service_Collection_In_Base., must conform to the pattern /^[A-Za-z0-9-.]*$/." );
		}
	...
	/**
	 * Gets delete_all_services
	 * @return bool
	 */
	public function get_delete_all_services() {
		return $this->container['delete_all_services'];
	}

	/**
	 * Sets delete_all_services
	 * @param bool $delete_all_services Set to true to delete all existing services (the services collection for this object should be empty collection when this option is used).
	 * @return $this
	 */
	public function set_delete_all_services( $delete_all_services ) {
		$this->container['delete_all_services'] = $delete_all_services;

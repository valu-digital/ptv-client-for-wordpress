...
/**
 * PTV_Contact_Details_In Class Doc Comment
 *
 * @category    Class
 * @description OPEN API - View Model of service location channel
 * @author      Valu Digital
 * @link        https://www.valu.fi
 */
class PTV_Contact_Details_In implements ArrayAccess {

	/**
	  * The original name of the model.
	  * @var string
	  */
	protected static $model_name = 'PTV_Contact_Details_In';

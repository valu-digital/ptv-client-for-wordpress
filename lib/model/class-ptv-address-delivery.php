...
/**
 * PTV_Address_Delivery Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://www.valu.fi
 */
class PTV_Address_Delivery implements ArrayAccess {

	/**
	  * The original name of the model.
	  * @var string
	  */
	protected static $model_name = 'PTV_Address_Delivery';
	...
	protected static $types = array(
		...
		'street_address' => 'PTV_Street_Address',
	...
	/**
	 * Sets street_address
	 * @param PTV_Street_Address $street_address Street address.
	 * @return $this
	 */
	 ...
	 * @param PTV_Language_Item[] $delivery_address_in_text Localized list of delivery address information.
	 * @return $this
	 */

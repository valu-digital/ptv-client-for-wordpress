...
/**
 * PTV_Address_With_Foreign_In Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://www.valu.fi
 */
class PTV_Address_With_Foreign_In implements ArrayAccess {

	/**
	  * The original name of the model.
	  * @var string
	  */
	protected static $model_name = 'PTV_Address_With_Foreign_In';
	 ...
	 * @param PTV_Language_Item[] $foreign_address Localized list of foreign address information. (Max.Length: 500).
	 * @return $this
	 */
	...
	public function set_country( $country ) {
		...
		if ( ! is_null( $country ) && ( ! preg_match( '/^[A-Z]{2}$/', $country ) ) ) {
			throw new InvalidArgumentException( "invalid value for $country when calling PTV_Address_With_Foreign_In., must conform to the pattern /^[A-Z]{2}$/." );
		}

 ...
 *
 * @category    Class
 * @description OPEN API V76 - View Model of web page channel
 * @author      Valu Digital
 * @link        https://www.valu.fi
 */
class PTV_Web_Page_Channel implements ArrayAccess {
	...
	public function set_source_id( $source_id ) {
		...
		if ( ! is_null( $source_id ) && ( ! preg_match( '/^[A-Za-z0-9-.]*$/', $source_id ) ) ) {
			throw new InvalidArgumentException( "invalid value for $source_id when calling PTV_Web_Page_Channel., must conform to the pattern /^[A-Za-z0-9-.]*$/." );
		}

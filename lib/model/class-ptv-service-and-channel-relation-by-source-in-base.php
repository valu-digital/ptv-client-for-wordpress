<?php
/**
 * PTV_Service_And_Channel_Relation_By_Source_In_Base
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PTV_Service_And_Channel_Relation_By_Source_In_Base Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://www.valu.fi
 */
class PTV_Service_And_Channel_Relation_By_Source_In_Base implements ArrayAccess {

	/**
	  * The original name of the model.
	  * @var string
	  */
	protected static $model_name = 'PTV_Service_And_Channel_Relation_By_Source_In_Base';
	...
	protected static $types = array(
		...
		'channel_relations' => 'PTV_Service_Service_Channel_By_Source[]',
	);
	 ...
	 * @return PTV_Service_Service_Channel_By_Source[]
	 */
	 ...
	 * @param PTV_Service_Service_Channel_By_Source[] $channel_relations Gets or sets the channel relations.
	 * @return $this
	 */
